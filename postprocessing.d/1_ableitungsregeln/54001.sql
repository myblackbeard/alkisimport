...
FROM (
	...
	FROM ax_vegetationsmerkmal o
	LEFT OUTER JOIN ap_ppo_unnested p ON o.gml_id = p.dientzurdarstellungvon_unnested AND p.art='BWS' AND p.endet IS NULL
	LEFT OUTER JOIN ap_darstellung_unnested d ON o.gml_id = d.dientzurdarstellungvon_unnested AND d.art='BWS' AND d.endet IS NULL
...
FROM ax_vegetationsmerkmal o
JOIN ap_ppo_unnested p ON o.gml_id = p.dientzurdarstellungvon_unnested AND p.art='ZUS' AND p.endet IS NULL
...
FROM ax_vegetationsmerkmal o
LEFT OUTER JOIN ap_pto_unnested t ON o.gml_id = t.dientzurdarstellungvon_unnested AND t.art='BWS' AND t.endet IS NULL
LEFT OUTER JOIN ap_darstellung_unnested d ON o.gml_id = d.dientzurdarstellungvon_unnested AND d.art='BWS' AND d.endet IS NULL
