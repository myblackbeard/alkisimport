...
LEFT OUTER JOIN ap_lpo_unnested l ON o.gml_id = l.dientzurdarstellungvon_unnested AND l.art='Schifffahrtslinie' AND l.endet IS NULL
LEFT OUTER JOIN ap_darstellung_unnested d ON o.gml_id = d.dientzurdarstellungvon_unnested AND d.art='Schifffahrtslinie' AND d.endet IS NULL
